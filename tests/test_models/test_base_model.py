...
class TestBaseModel(unittest.TestCase):
    ...
    def test_pep8_conformance_test_base_model(self):
        """Check if tests/test_models/test_base_model.py conforms to PEP8"""
        pep8style = pep8.StyleGuide(quiet=True)
    ...
    def test_base_types(self):
        """Test attributes types in BaseModel"""
    ...
    def test_datetime_model(self):
        """Test that BaseModel instances have valid datetime attributes"""
        model_3 = BaseModel()
        model_4 = BaseModel()
    ...
    def test_file_save(self):
        """Test that information is saved to the file"""
        b3 = BaseModel()
        b3.save()
